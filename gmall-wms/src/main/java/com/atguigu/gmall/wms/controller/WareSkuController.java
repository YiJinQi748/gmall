...
public class WareSkuController {
    ...
    public ResponseVo<List<WareSkuEntity>> queryStockBySkuId(@PathVariable("skuId")Long sid){
        return ResponseVo.ok(this.wareSkuService.list(Wrappers.lambdaQuery(WareSkuEntity.class).eq(WareSkuEntity::getSkuId,sid)));
    }
